...
with col2:
    ...
    st.write("I have used a stoic API to generate the random quotes. You can try and start receiving a random stoic quote! Note: This project is still in progress.")
