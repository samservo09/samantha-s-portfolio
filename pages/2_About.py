...
st.write("How contrasting, right? I want to work in a numerical heavy career yet I hated Math? Yes, in fact, I took the ABM (Accountancy and Business Management) strand in Senior High School. I was scared of Math.")
st.write("I took Computer Science in college even though I know that it will be Math-heavy. I just thought to myself that I can do it even without all the Math prereqs. But something happened when I was in college that made me go back to Math.")
st.write("The root of my problem: Not understanding how to study Math. After failing a course in my program which is Math-heavy, I bought myself a College Algebra book, and taught myself again about Math! I'm still doing it now as you are reading this. (I want to finish the book!)")